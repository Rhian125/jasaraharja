...
class User extends CI_Controller {
  ...
  public function index() {
    if (!($this->session->userdata('id_admin'))) {
      ...
      $data["text"]   = $this->m_user->fetch_text($config["per_page"], $page);
      $data["column"] = $this->m_user->select_column_name($this->db->database);
  ...
  public function result() {
    if (!($this->session->userdata('user_id'))) {
      ...
      $config["total_rows"]  = $this->m_user->record_count_search($data['cari'], $this->input->post('column_name'));
      $config["per_page"]    = $limit;
      ...
      $data["text"]   = $this->m_user->fetch_text_search($config["per_page"], $page, $data['cari'], $this->input->post('column_name'));
      $data["column"] = $this->m_user->select_column_name($this->db->database);
      $data["links"]  = $this->pagination->create_links();
  ...
  public function delete() {
    $this->m_user->delete($this->input->post('text_id'));
    redirect('text');
  }
