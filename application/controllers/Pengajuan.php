...
class Pengajuan extends CI_Controller {
  ...
  public function index() {
    if (!($this->session->userdata('id_admin'))) {
      ...
      $config["total_rows"]  = $this->m_pengajuan->record_count();
      ...
      $data["text"]   = $this->m_pengajuan->fetch_text($config["per_page"], $page);
      $data["column"] = $this->m_pengajuan->select_column_name($this->db->database);
  ...
  public function result() {
    if (!($this->session->userdata('user_id'))) {
      ...
      $config["total_rows"]  = $this->m_pengajuan->record_count_search($data['cari'], $this->input->post('column_name'));
      $config["per_page"]    = $limit;
      ...
      $data["text"]   = $this->m_pengajuan->fetch_text_search($config["per_page"], $page, $data['cari'], $this->input->post('column_name'));
      $data["column"] = $this->m_pengajuan->select_column_name($this->db->database);
      $data["links"]  = $this->pagination->create_links();
  ...
  public function delete() {
    $this->m_pengajuan->delete($this->input->post('text_id'));
    redirect('text');
  }
